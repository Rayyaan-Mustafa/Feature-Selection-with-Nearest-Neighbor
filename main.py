...
def main():
    ...
    print("Running nearest neighbor with all " + str(len(data[0]) - 1) + " features, using \"leaving-one-out\" evaluation, I get an accuracy of " + str(leave_one_out_cross_validation(data, set(range(1,len(data[0]))), 0,0)*100) + "%")
    ...
    print("Search took " + str(round(end-start,2)) + " seconds.")#spurious precision!!
